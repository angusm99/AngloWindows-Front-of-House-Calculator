...
This repository contains the Anglo Windows reception quote calculator, rebuilt locally from the latest Manus project files and organized as a FastAPI-served browser app.
